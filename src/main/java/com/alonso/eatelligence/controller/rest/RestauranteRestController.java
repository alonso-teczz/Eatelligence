...
public class RestauranteRestController {
    ...
    public Page<ResumenProjection> goIndex(
        ...
        return restauranteService.getAllRestaurantsWithFilters(
                nombre, min, max, lat, lon, radio, alergenos, categorias,
                dia, hora, pageable);
    }
     ...
     */
    @GetMapping("/schedule")
    public ResponseEntity<Map<String, List<HorarioDTO>>> getSchedule(
            @SessionAttribute("restauranteId") Long restauranteId
    ) {
        List<HorarioDTO> horarios = this.restauranteService.obtenerHorarios(restauranteId);
    ...
    public ResponseEntity<?> updateHorario(
        @SessionAttribute("restauranteId") Long restauranteId,
        @RequestBody @Valid List<HorarioDTO> nuevoHorario
    ) {
