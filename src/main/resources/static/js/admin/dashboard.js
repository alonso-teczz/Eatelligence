document.addEventListener('DOMContentLoaded', () => {
  ...
  const pintaTiempo = () => {
    if (currentTiempo !== null) {
      ...
      tiempoCardText.innerHTML = '<i class="bi bi-exclamation-triangle-fill fs-5 text-warning me-2"></i><em>Si no fijas un tiempo estimado de preparación, el tiempo de entrega estimado no podrá ser calculado, por lo que aparecerá como “<b>No disponible</b>” para los usuarios.</em>';
